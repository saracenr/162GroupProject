 ...
 * stepsSinceBreed
 *
 * Description: This class is the base critter class for the simulation. It has 
 * virtual move, breed and starve functions for derived classes to define.
 * With getters and setters for each member variable.  As well as 
